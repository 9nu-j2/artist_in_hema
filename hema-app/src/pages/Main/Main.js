...
function 랜덤선택(랜덤아이디) {
  var i = 0;
  var num = 0;
  var 아이디 = dummy.members.filter((id) => {
    return id;
  });
  var array = Array(아이디.length)
    .fill()
      ...
      <div className="Fixed">
        <div className="Imagebox">
          ...
          <div className="Bsentence">
            ...
            <div className="Big2">
              Find your joy with amazing people in HEMA
            </div>
          </div>
...
function CardSlide(props) {
  if (props.카드 === 1) {
    return (
      <div className="Card">
        <div className="Profile1" id="card1">
          <img
            src={require("../../sample/" + props.랜덤아이디[0] + ".jpeg")}
          ></img>
        </div>
        <div className="Profile2" id="card2">
          <img
            src={require("../../sample/" + props.랜덤아이디[1] + ".jpeg")}
          ></img>
        </div>
        <div className="Profile3" id="card3">
          <img
            src={require("../../sample/" + props.랜덤아이디[2] + ".jpeg")}
          ></img>
        </div>
        <div className="Profile2" id="card4">
          <img
            src={require("../../sample/" + props.랜덤아이디[3] + ".jpeg")}
          ></img>
        </div>
        <div className="Profile1" id="card5">
          <img
            src={require("../../sample/" + props.랜덤아이디[4] + ".jpeg")}
          ></img>
        </div>
      </div>
    );
