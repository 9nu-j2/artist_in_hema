    ...
    <div className="This">
      ...
      <div className="Page2">
        <div className="Nemo">
          ...
          <div className="P3">
            <label className="La" for="chooseFile">
              📸사진을 골라주세요📸
            </label>
            <input
              type="file"
          ...
          <div className="P4">
            <div className="Font">세션선택(중복가능)</div>
            <div className="Sess">
              <label>
                <input
                  type="checkbox"
          ...
          <div className="P5">
            <div className="Font">참여했던 밴드(최대5개)</div>
            <div className="band">
              <div className="input-container">
                <input
                  type="text"
          ...
          <div className="btn">
            <button class="button-77" role="button" onClick={sendData}>
              등록하기
            </button>
          </div>
          <div className="Empty"></div>
...
function Policy() {
  return (
    <div className="Page2">
      ...
      <h3>
        이 사이트는 한양대학교 ERICA 밴드 동아리 HEMA의 졸업생 및 재학생 멤버
        정보를 관리하기 위한 사이트입니다
      </h3>
      <h3>📍 등록 기준</h3>
      <p>
        2년 이상 동아리 회원으로 활동하였으며 졸업 이후에도 동아리 행사에
        참여하였거나 회원들과의 모임에 참여하는 자
      </p>
      <h3>📍 등록 방법</h3>
      <p>
        하단에 있는 양식에 따라 정보를 기입하여 제출하여 주시면 간단한 확인
        이후에 멤버 정보를 등록해드립니다
      </p>
      <h3>📍 정보 관리</h3>
      <p>
        전화 번호 등 개인신상과 관련된 정보는 차후 동아리 관련 연락을 위한
        목적으로만 사용되며 사이트에서는 노출되지 않습니다
      </p>
      <p>🛠🛠🛠</p>
      <p>문의 및 버그 신고 👉 12 이준구 📱 010-4139-1978</p>
      <p>
        개발 및 운영 총괄 👉 12 이준구 <a href="https://jun9.oopy.io/">🚀</a>
      </p>
      <p>
        <a href="https://github.com/2-jun9/artist_in_hema">소스코드 열람 👀</a>
      </p>
    </div>
  );
}
